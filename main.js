    ...
    window.navigator.geolocation.getCurrentPosition(function (data) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#location').append('<div class="container"><h1 class="display-4">Your Current Location is :</h1><p><strong>' + city + ', ' + district + ', ' + state + ', ' + country + ', ' + continent + '</strong></p></div>');
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $.each(results, function (key, value) {
                            ...
                            $('#img').append('<div class="col-md-4 mt-2"><div class="card mt-2" style="width: 18rem;"><img class="card-img-top img-thumbnail" style="height: 300px; width: 600px;" src="' + image + '" ></div></div>');
